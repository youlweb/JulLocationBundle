...
class LocationToObjectTransformer implements DataTransformerInterface
{
	...
	{
		if( ( $locationName = $location->getName() ) === null ) return $location;
		...
		$locationDB = $this	->om
							...
							->getOneByLocationName( $locationName, $location->getAddress(), $location->getCity()->getName(), $location->getCity()->getState()->getName(), $location->getCity()->getState()->getCountry()->getName() );
