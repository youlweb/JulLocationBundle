...
use Jul\LocationDemoBundle\Form\DataTransformer\CountryTransformer;
 ...
 *
 */
class CountryTransformerTest extends WebTestCase
{
	/**
	...
	/**
	 * @var \Jul\LocationBundle\Form\DataTransformer\CountryTransformer
	 */
	...
	public function setUp()
	{
		...
		$this->entityTransformer = new \Jul\LocationBundle\Form\DataTransformer\CountryTransformer( $this->om );
		
		$this->repository = $this->om->getRepository('JulLocationBundle:Country');
	}
