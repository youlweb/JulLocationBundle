...
use Jul\LocationDemoBundle\Form\DataTransformer\StateTransformer;
 ...
 *
 */
class StateTransformerTest extends WebTestCase
{
	/**
	...
	/**
	 * @var \Jul\LocationBundle\Form\DataTransformer\StateTransformer
	 */
	...
	public function setUp()
	{
		...
		$this->entityTransformer = new \Jul\LocationBundle\Form\DataTransformer\StateTransformer( $this->om );
		
		$this->repository = $this->om->getRepository('JulLocationBundle:State');
	...
	public function testReverseTransformCreate()
	{
		...
		$entity1->setCountry( $this->country );
		...
		$entity2->setCountry( $this->country );
