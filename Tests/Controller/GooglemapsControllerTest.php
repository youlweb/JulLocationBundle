...
class GooglemapsControllerTest extends TypeTestCase
{
	/**
	...
	public function setUp()
	{
		...
		$managerInstance = new ObjectManagerInstance2();
	...
	public function testplacesAutocompleteAction()
	{
		...
		foreach( $this->entitiesArray as $entity )
		{
			...
			$controller->placesAutocompleteAction( $view );
			
			// container is missing, but try this:
			
			// http://symfony.com/doc/2.0/book/testing.html#accessing-internal-objects
...
class ObjectManagerInstance2 extends WebTestCase
{
